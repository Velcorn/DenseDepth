...
def get_nyu_callbacks(model, train_generator, test_generator, test_set, runPath):
    callbacks = []
    ...
    # JW: Updated period=5 to save_freq=5*batch_size (nyu=12762, chalearn_249=12450, AUTSL=12500).
    batch_size = 12500
